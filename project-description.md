...
[Trailer](https://youtu.be/vQLqbzaNdg0) - The trailer is made with the same intentions as the press kit by giving the player a snapshot of the game. The trailer shows many clips of combat and different combinations of card options. The soundtrack used for the trailer is also in the game.
