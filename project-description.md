...
# How to Play
Use WASD or the arrow keys to move around the maps. Press shift to do a quick roll in the direction you're facing (if you're standing still, you can do a dodge in place). Can press or hold left click to fire your ranged weapon and right click to use your melee weapon. If a spell is acquired, press Space to activate it. 
